      ...
      <div class="section-inner">
        ...
        <div class="pilares-grid" style="margin-top:50px;">
          <div class="pilar-card social reveal">
            ...
            <p>A arte é o eixo central do Pé de Manga. Desenvolvemos oficinas, vivências, apresentações, exposições e
          ...
          <div class="pilar-card social reveal">
            ...
            <p>Entendemos a arte como prática de cuidado. Nossas ações promovem espaços de escuta, convivência e
              fortalecimento emocional. O ambiente do Pé de Manga é estruturado para acolher, desacelerar e favorecer
              experiências que integrem corpo, mente e sensibilidade.</p>
          </div>
          <div class="pilar-card social reveal">
            <h3>Sustentabilidade e Natureza</h3>
            <p>O contato com a natureza é parte da nossa identidade. O jardim, os processos manuais e o cuidado com o
              espaço refletem nosso compromisso com práticas sustentáveis. Incentivamos o reaproveitamento de materiais
        ...
        <div class="agenda-note reveal">
          <div class="an-icon"><svg xmlns="http://www.w3.org/2000/svg" height="56px" viewBox="0 -960 960 960" width="56px" fill="#FFFFFF"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Zm280 240q-17 0-28.5-11.5T440-440q0-17 11.5-28.5T480-480q17 0 28.5 11.5T520-440q0 17-11.5 28.5T480-400Zm-188.5-11.5Q280-423 280-440t11.5-28.5Q303-480 320-480t28.5 11.5Q360-457 360-440t-11.5 28.5Q337-400 320-400t-28.5-11.5ZM640-400q-17 0-28.5-11.5T600-440q0-17 11.5-28.5T640-480q17 0 28.5 11.5T680-440q0 17-11.5 28.5T640-400ZM480-240q-17 0-28.5-11.5T440-280q0-17 11.5-28.5T480-320q17 0 28.5 11.5T520-280q0 17-11.5 28.5T480-240Zm-188.5-11.5Q280-263 280-280t11.5-28.5Q303-320 320-320t28.5 11.5Q360-297 360-280t-11.5 28.5Q337-240 320-240t-28.5-11.5ZM640-240q-17 0-28.5-11.5T600-280q0-17 11.5-28.5T640-320q17 0 28.5 11.5T680-280q0 17-11.5 28.5T640-240Z"/></svg></div>
          <div>
            <h3>Agenda de Atividades</h3>
            <p>Acompanhe nossa programação mensal no Instagram ou envie um e-mail para agendar uma visita. Atividades no
              nosso espaço (<strong>Vem pro Pé</strong>) e em
            ...
            <div class="an-btns">
              ...
              <a href="https://www.instagram.com/pedemangacpv/" target="_blank" class="btn btn-outline"
        ...
        <div class="mapa-section reveal">
          ...
          <div class="mapa-wrap">
            <iframe src="https://maps.google.com/maps?q=Pé+de+Manga+Caçapava+SP&t=&z=17&ie=UTF8&iwloc=&output=embed"
          ...
          <div class="mapa-cta">
            <a href="https://maps.app.goo.gl/WJmJwxNSUe2Vjo5g7" target="_blank" class="btn btn-primary">
              <span style="vertical-align:middle;"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#4a2f2a"><path d="M200-120v-680h360l16 80h224v400H520l-16-80H280v280h-80Zm300-440Zm86 160h134v-240H510l-16-80H280v240h290l16 80Z"/></svg></span> Abrir no Google Maps
            </a>
          </div>
        </div>
      </div>
