...
<body>
  ...
  <div class="page-wrap">
    <div class="page-hero">
      ...
      <p>Um espaço dedicado à arte como caminho de cuidado, pertencimento e transformação social.</p>
    </div>
    <section>
      <div class="section-inner">
        <div class="quem-grid">
          <div class="quem-text">
            <p class="reveal">O <strong>Pé de Manga &#x2013; Cultura e Afeto</strong> é um espaço dedicado à arte
              como caminho de cuidado, pertencimento e transformação social. Atuamos na intersecção entre cultura, saúde
              mental, sustentabilidade e bem-estar, promovendo experiências que fortalecem vínculos e ampliam
            ...
            <p class="reveal">Somos um território de encontros, formação e criação. Aqui, o fazer artístico dialoga com
              ...
              vivências culturais, ações formativas e práticas de cuidado coletivo.</p>
            ...
            <div class="ponto-cultura reveal">
              ...
              <div class="ponto-text">
                ...
                <p>O Pé de Manga é reconhecido pelo Ministério da Cultura como Ponto de Cultura, integrando uma rede
          ...
          <div class="mvv-cards">
            <div class="mvv-card reveal">
              <h4>Missão</h4>
              <p>Promover a arte como prática de cuidado, fortalecendo a saúde mental, os vínculos comunitários e o
                desenvolvimento humano por meio de ações culturais acessíveis, sustentáveis e socialmente responsáveis.
              </p>
            </div>
            <div class="mvv-card reveal">
              <h4>Visão</h4>
              <p>Ser referência como espaço cultural de base comunitária que integra arte, natureza e bem-estar,
                consolidando-se como território de pertencimento, formação e transformação social.</p>
            </div>
            <div class="mvv-card reveal">
              <h4>Valores</h4>
              <p>Cultura como direito. Arte como ferramenta de cuidado. Ética, responsabilidade social, acolhimento,
                escuta e respeito às diversidades. Sustentabilidade, pertencimento e autonomia como pilares para um
          ...
          <div class="card-comunica" style="display:grid;grid-template-columns:repeat(5,1fr);gap:16px;margin-top:30px;">
            ...
            foreach ($valores as $v): ?>
              <div
                ...
                <p style="font-size:.78rem;font-weight:600;color:var(--marrom-escuro);line-height:1.4;">
                  <?php echo $v[1]; ?></p>
              </div>
            <?php endforeach; ?>
          </div>
          ...
          <?php if (empty($colaboradores)): ?>
            <div class="colab-empty">
              <span class="material-symbols-outlined"
                style="font-size:3rem;color:var(--amarelo);display:block;margin-bottom:14px;">group</span>
              ...
              <?php foreach ($colaboradores as $c): ?>
                <div class="colab-card reveal">
                  <div class="colab-avatar">
                    <?php if (!empty($c['foto'])): ?>
                      <img src="data/uploads/<?= htmlspecialchars($c['foto']) ?>" alt="<?= htmlspecialchars($c['nome']) ?>">
                    <?php else: ?>
                      <span class="material-symbols-outlined"
                        style="font-size:2rem;color:var(--marrom-escuro);opacity:.75;">person</span>
                    <?php endif; ?>
                  </div>
