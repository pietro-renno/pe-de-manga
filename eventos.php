...
<body>
  ...
  <div class="page-wrap">
    <div class="page-hero">
      ...
      <p>Selecione um evento para ver as fotos.</p>
    </div>
                    ...
                    <?php foreach ($fotos as $foto): ?>
                      <div class="eventos-foto-item"
                        ...
                        <img src="data/uploads/<?= htmlspecialchars($foto['arquivo']) ?>"
                             alt="<?= htmlspecialchars($foto['descricao'] ?? $ev_sel['nome']) ?>"
                             loading="lazy">
  ...
  <div id="lightbox" onclick="fecharLightbox()">
    <button onclick="fecharLightbox()" style="position:fixed;top:18px;right:24px;background:none;border:none;color:#fff;font-size:2rem;cursor:pointer;z-index:401;">&times;</button>
