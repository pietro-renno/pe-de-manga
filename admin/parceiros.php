        ...
        <div class="admin-card">
          ...
          <div class="admin-card-body">
            <?php if (empty($parceiros)): ?>
              <p style="text-align:center;padding:40px;color:var(--marrom);opacity:.6;">Nenhum parceiro cadastrado ainda.</p>
            <?php else: ?>
              <table>
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php foreach ($parceiros as $p): ?>
                    <tr>
                      ...
                      <td>
                        <?php if (!empty($p['site'])): ?>
                          <a href="<?= htmlspecialchars($p['site']) ?>" target="_blank" style="color:var(--verde);font-size:.82rem;"><?= htmlspecialchars($p['site']) ?></a>
                        <?php else: ?>—<?php endif; ?>
                      </td>
