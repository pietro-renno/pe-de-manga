        ...
        <div class="admin-card">
          ...
          <div class="admin-card-body">
            <?php if (empty($galeria)): ?>
              <p style="text-align:center;padding:50px;color:var(--marrom);opacity:.6;">Nenhuma foto na galeria ainda. Adicione a primeira!</p>
            <?php else: ?>
              <div class="galeria-adm-grid">
                <?php foreach ($galeria as $foto): ?>
                  <div class="gal-thumb">
                    <img src="../data/uploads/<?= htmlspecialchars($foto['arquivo']) ?>" alt="<?= htmlspecialchars($foto['descricao'] ?? '') ?>">
                    ...
                    <?php if (!empty($foto['descricao'])): ?>
                      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,.5);color:#fff;font-size:.65rem;padding:4px 6px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;">
    ...
    <div class="modal-box" onclick="event.stopPropagation()" style="max-width:580px;">
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="file" id="fotosInput" name="fotos[]" multiple accept="image/*" style="display:none" onchange="previewImages(this)">
