...
<head>
  ...
  <link rel="stylesheet"
    href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=delete,edit,group" />
</head>
        ...
        <div class="admin-card">
          ...
          <div class="admin-card-body">
            <?php if (empty($colaboradores)): ?>
              <p style="text-align:center;padding:40px;color:var(--marrom);opacity:.6;">Nenhum colaborador cadastrado ainda.</p>
            <?php else: ?>
              <table>
                <thead>
                  <tr>
                      ...
                      <td>
                        <div class="td-actions">
                          ...
                          <form method="POST" onsubmit="return confirm('Remover este colaborador?')">
                            ...
                            <button type="submit" class="btn-adm btn-adm-danger"><span class="material-symbols-outlined pi-icon">delete</span> Remover</button>
                          </form>
                        </div>
                      </td>
                    </tr>
